...
public class BuscaCepEnderecoCampoVazioVerificationPoint {
	...
	public void checarBuscaCepEnderecoCampoVazio() throws InterruptedException {
		...
		if(expectedMessage) {
			Report.log(Status.PASS, "O Teste Retornou A Mensagem Esperada \"Informe o Endereço !\"",  Screenshot.capture(driver));
			pass = true;
		}	
		else {
			Report.log(Status.FAIL, "O Teste Não Retornou A Mensagem Esperada \"Informe o Endereço !\"",  Screenshot.capture(driver));
		}
